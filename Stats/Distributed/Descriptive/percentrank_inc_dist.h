...
#include "../Descriptive/percentrank_inc.h"
...
template <typename T>
struct percentrank_inc_dist_t : public percentrank_inc_t<T>
{
    percentrank_inc_dist_t(T value, TCSize_t significance) : percentrank_inc_t(value, significance)
    {
    }
