...
template<typename T>
TCErrorCode math_desc_slope(TCDistArray *known_ys, TCDistArray *known_xs, TCDistArray *output)
{
    std::vector<T> tmpMem;
...
TCErrorCode math_desc_slope_d_e_dist(TCDistArray *known_ys, TCDistArray *known_xs, TCDistArray *output)
{
    return math_desc_slope<TCDouble>(known_ys, known_xs, output);
}

TCErrorCode math_desc_slope_f_e_dist(TCDistArray *known_ys, TCDistArray *known_xs, TCDistArray *output)
{
    return math_desc_slope<TCFloat>(known_ys, known_xs, output);
}

TCErrorCode math_desc_slope_z_e_dist(TCDistArray *known_ys, TCDistArray *known_xs, TCDistArray *output)
{
    return math_desc_slope<TCDComplex>(known_ys, known_xs, output);
}

TCErrorCode math_desc_slope_c_e_dist(TCDistArray *known_ys, TCDistArray *known_xs, TCDistArray *output)
{
    return math_desc_slope<TCFComplex>(known_ys, known_xs, output);
}
