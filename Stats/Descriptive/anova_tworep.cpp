...
#include "stdafx.h"
#include "anova_tworep.h"

using namespace Descriptive;

TCErrorCode stats_infer_anova_two_way_rep_compute_f_e(const TCArray* data,
    ...
    TCArray* s_var_col_sample)
{
    ...
    return stats_infer_anova_tworep<TCFloat>(data, cnt_row_sample, alpha,
...
TCErrorCode stats_infer_anova_two_way_rep_compute_d_e(const TCArray*   data,
    TCUInt64  cnt_row_sample,
    TCDouble  alpha,
    TCDouble* f_sample,
    TCDouble* f_col,
    ...
    TCArray* s_var_col_sample)
{
    ...
    return stats_infer_anova_tworep<TCDouble>(data, cnt_row_sample, alpha,
                                            f_sample, f_col, f_int,
                                            p_sample, p_col, p_int,
                                            f_crit_sample, f_crit_col, f_crit_int,
                                            ss_sample, ss_col, ss_int, ss_err, ss_tot,
